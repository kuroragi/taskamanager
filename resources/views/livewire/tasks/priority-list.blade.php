        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        Obligation</th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Desire
                    </th>
                ...
                @forelse($tasks as $task)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if ($task->deadline)
                                <span
                                    class="text-sm {{ $task->deadline->isPast() ? 'text-red-600 font-semibold' : ($task->deadline->diffInDays() <= 3 ? 'text-orange-600' : 'text-gray-900') }}">
